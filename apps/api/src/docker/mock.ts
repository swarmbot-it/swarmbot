...
const SERVICES: MockService[] = [
	...
	svc("svc_frontend_app", "frontend_app", "ghcr.io/sw4rmbot/web:2.14.0", 4, "frontend", [
	...
	svc("svc_auth", "api-gateway_auth", "ghcr.io/sw4rmbot/auth:1.8.3", 2, "auth", [
	...
	svc("svc_billing", "billing_worker", "ghcr.io/sw4rmbot/billing:1.2.0", 3, "billing", []),
	svc(
		"svc_transcoder",
		"media-proc_ffmpeg",
		"ghcr.io/sw4rmbot/transcoder:0.9.1",
		2,
		"media-proc",
		[]
	),
